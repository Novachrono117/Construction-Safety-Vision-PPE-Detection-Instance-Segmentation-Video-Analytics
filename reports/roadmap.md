...
### Phase 8F - the S1 overlap-mask controlled experiment (next, not started)

Run S1 exactly once under the frozen protocol, evaluate it under the canonical
evaluator and the direct-IoU diagnostic, then apply the frozen comparison policy.
