...
Version: 1.9 · Current phase: **7 - Detection experiments and model freeze** (7A protocol frozen, 7B D1 complete and BELOW_D0; 7C next: D2, no winner yet)
...
| 7 | Detection experiments and model freeze | in progress (7A protocol frozen · 7B D1 capacity complete, `BELOW_D0` · **7C next**: D2 resolution · no winner declared) |
...
### Phase 7C - D2 resolution experiment (next, not started)
