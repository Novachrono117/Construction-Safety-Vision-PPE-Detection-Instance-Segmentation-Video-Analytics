...
| 10 | Controlled validation comparison | in progress (**10A `DETECTOR_SEGMENTER_COMPARISON_PROTOCOL_FROZEN`**: the comparison protocol is frozen and not executed, protocol fingerprint `d92a1576...` · 10B recognition and spatial comparison · 10C latency and memory benchmark · 10D operational synthesis - none started) |
...
| 10B | Controlled validation recognition and spatial comparison | not started |
