...
PANEL = (
    ...
    ".csv-academic p,.csv-academic li{color:#202923 !important}"
    ".csv-academic table{border-collapse:collapse;margin:10px 0;width:100%;background:#fff}"
    ".csv-academic caption"
    "{text-align:left;font-weight:700;padding:6px 0;color:#202923 !important}"
    ".csv-academic th,.csv-academic td{border:1px solid #ced7cc;padding:5px 9px;text-align:left;"
    "font-size:14px;color:#202923 !important;background:#fff}"
    ".csv-academic th{background:#e6eade !important;font-weight:700}"
